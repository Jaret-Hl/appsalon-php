<h1 class="nombre__pagina">Crear Cuenta</h1>
<p class="descripcion__pagina">Completa tus datos en el siguiente formulario para crear una cuenta</p>

<?php 
    include_once __DIR__ . "/../templates/alertas.php";
?>

<form action="/crear__cuenta" method="post" class="formulario">
    <div class="campo">
